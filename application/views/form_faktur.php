<div class="row">
	<div class="col-md-12">
	<form action="supplier/simpan_penjualan" method="POST">
		<div class="form-group">
            <label>Kode Pemesanan </label>
            <input type="text" class="form-control" name="kode_faktur" id="kode_faktur" value="<?php echo $kodeurut; ?>" readonly/>
        </div>
        ...
        <table class="table table-bordered">
        	<tr>
        		...
        		<th>
					...
					<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Masukan Barang</button>
        		</th>
        	</tr>
        	<tr>
        	<?php $i=1; $no=1;?>
            <?php foreach($this->cart->contents() as $items): ?>
                ...
                <td>
                    <a href="supplier/hapus_cart/<?php echo $items['rowid'] ?>" class="btn btn-warning btn-sm">X</a>
                </td>
        	</tr>
        	<?php $i++; $no++;?>
            <?php endforeach; ?>
        ...
        <div class="form-group">
            ...
            <a href="supplier/penjualan" class="btn btn-default">Close</a>
        </div>
	</form>
	</div>
</div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form action="supplier/simpan_cart" method="POST">
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#nama_barang').change(function() {
      ...
      $.ajax({
        type : 'POST',
        url : '<?php echo base_url('supplier/cek_barang') ?>',
        Cache : false,
        dataType: "json",
        data : 'kode_barang='+id,
