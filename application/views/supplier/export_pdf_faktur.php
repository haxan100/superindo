...
$pdf->WriteHTMLCell(0, 0, '', '', $title, 0, 1, 0, true, 'C', true);
	...
	$table .= '<tr style="background-color:#ccc;">
					...
					<th style="border:1px solid #000;">TANGGAL TRANSAKSI </th>
	...
	$table .=	'<tr>
					...
					<td style="border:1px solid #000;">'.$row->kode_faktur.'</td>
					<td style="border:1px solid #000;">'.$row->tgl_faktur.'</td>
...
ob_clean();
$pdf->Output('report_barang_masuk.pdf', 'I');
